# NYU MedML. (2021). Variationally Regularized Graph-based Representation Learning for Electronic Health Records. GitHub repository. Available at: https://github.com/NYUMedML/GNN_for_EHR
